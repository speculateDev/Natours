...
})({"7o8gy":[function(require,module,exports) {
...
if (updateForm) updateForm.addEventListener("submit", (e)=>{
    ...
    (0, _updateSettings.updateSettings)(form, "Account");
});
// UPDATE PASSWORD
...
/* eslint-disable */ // Parse locations from the data attribute
...
const logout = async ()=>{
    try {
        ...
        if (res.data.status === "success") location.reload(true); // true => not load page from cache
    } catch (err) {
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "Success") (0, _alert.showAlert)("success", `${type.toUpperCase()} successfully updated!`);
    } catch (err) {
        (0, _alert.showAlert)("error", err.response.data.message);
    }
};
...
const bookTour = async (tourID)=>{
    const stripe = Stripe("pk_test_51Pc7khIkn2z7frMRjuQsE284mIYk0GN5IISXBP6iJtqHpClri4IT3mB4dudEmqjOX6cqndnkLkDJq9yt5h5KMwMC00F0TlqxsX");
    try {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}]},["7o8gy","f2QDv"], "f2QDv", "parcelRequire11c7")
